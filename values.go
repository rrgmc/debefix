...
type Values interface {
	Get(fieldName string) (val any, ok bool)  // gets the value of a field, returning whether the field exists.
...
func (v MapValues) Get(fieldName string) (val any, ok bool) {
	val, ok = v[fieldName]
	return
}
